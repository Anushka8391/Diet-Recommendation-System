...
export default function DietRecommendation() {
  ...
  return (
    <div className="container py-8">
      ...
      <div className="mb-6 rounded-xl border bg-card px-4 py-3 text-sm text-muted-foreground" style={{ boxShadow: "var(--shadow-card)" }}>
        Need support? Contact: <Link to="/contact" className="font-semibold text-primary underline underline-offset-4">Anushka Singh</Link>
      </div>
