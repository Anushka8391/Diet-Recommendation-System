      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative grid items-center gap-8 py-16 md:grid-cols-2 md:py-24">
          <div className="space-y-6">
            ...
            <p className="inline-flex items-center rounded-full border border-primary/30 bg-primary/5 px-4 py-1 text-sm font-semibold text-primary">
              Made with <span className="mx-1 text-red-500">❤</span> by Anushka Singh
            </p>
